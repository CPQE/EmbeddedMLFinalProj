/**
  ...
  ******************************************************************************
  */
#ifndef AI_ROAD_CNN_H
#define AI_ROAD_CNN_H

#include "road_cnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ROAD_CNN_MODEL_NAME          "road_cnn"
#define AI_ROAD_CNN_ORIGIN_MODEL_NAME   "stm32_road_model32_final"

/******************************************************************************/
#define AI_ROAD_CNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ROAD_CNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ROAD_CNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ROAD_CNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_ROAD_CNN_IN \
  ai_road_cnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ROAD_CNN_IN_SIZE { \
  AI_ROAD_CNN_IN_1_SIZE, \
}
#define AI_ROAD_CNN_IN_SIZE_BYTES { \
  AI_ROAD_CNN_IN_1_SIZE_BYTES, \
}
#define AI_ROAD_CNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ROAD_CNN_IN_1_HEIGHT      (600)
#define AI_ROAD_CNN_IN_1_CHANNEL     (23)
#define AI_ROAD_CNN_IN_1_SIZE        (13800)
#define AI_ROAD_CNN_IN_1_SIZE_BYTES  (55200)

/******************************************************************************/
#define AI_ROAD_CNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ROAD_CNN_OUT \
  ai_road_cnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ROAD_CNN_OUT_SIZE { \
  AI_ROAD_CNN_OUT_1_SIZE, \
}
#define AI_ROAD_CNN_OUT_SIZE_BYTES { \
  AI_ROAD_CNN_OUT_1_SIZE_BYTES, \
}
#define AI_ROAD_CNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ROAD_CNN_OUT_1_CHANNEL     (1)
#define AI_ROAD_CNN_OUT_1_SIZE        (1)
#define AI_ROAD_CNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_ROAD_CNN_N_NODES (5)
 ...
 * @ref ai_road_cnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_road_cnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_road_cnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_road_cnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ROAD_CNN_*
 * defines into file @ref road_cnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
